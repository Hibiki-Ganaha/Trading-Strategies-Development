...
-	Using the yfinance module in Python to collect and clean stock data from the DJIA index
-	Analyzing 5 different trading strategies in MATLAB to determine the most profitable strategy for a portfolio of 15 stocks from the DJIA index
-	Paper trading on Charles Schwab’s thinkorswim platform to put $10,000 in each strategy and track and compare the results to the backtester
